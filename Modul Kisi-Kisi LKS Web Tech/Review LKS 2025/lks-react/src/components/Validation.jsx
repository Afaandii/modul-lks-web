export  default function Validation(){
    return (
        <div>
            ...
            <main>
                <header class="jumbotron validation-header">
                    <div class="container">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control reason-accep"    cols="200" rows="6"placeholder="Explain why you should be accepted"></textarea>
                                </div>
                            </div>
                        </div>

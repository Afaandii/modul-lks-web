...
export default function Dashboard(){
    return (
        ...
        <div>
            ...
            <div className="">
            {/* header */}
                <header class="jumbotron container-header">
                    <div class="container">
                ...
                <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <a href={"/validation"} class="btn btn-primary btn-block text-white     ">+ Request validation</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="validation-section mb-5">
                        <div class="section-header mb-3">
                            <div class="row">
                                <div class="col-md-8">
                                ...
                                <div class="col-md-4">
                                    <a href={"/job-vacancies"}     class="btn btn-primary btn-lg btn-block">+ Add Job Applications</a>
                                </div>
                            </div>
                        </div>

export default function ShowVacancies(){
    return (
        ...
        <main>
            <header class="jumbotron   show-container" >
                ...
                <div class="row mb-3">
                            ...
                            <table class="table table-bordered table-hover table-striped"> 
                                <tr>
                                    ...
                                    <th rowSpan={4}  width="1" >
                                        <a href="" class="btn btn-primary btn-lg button-apply-job"  >Apply for this job</a>
                                    </th>
                                </tr>
                                <tr>    
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control  container-area-show  " cols="30" rows="6" placeholder="Explain why you should be accepted"></textarea>
                        </div>
                    </div>
                </div>
